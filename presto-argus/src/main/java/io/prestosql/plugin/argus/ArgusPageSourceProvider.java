...
public class ArgusPageSourceProvider
        implements ConnectorPageSourceProvider
{
    private ArgusRecordSetProvider recordSetProvider;

    @Inject
    public ArgusPageSourceProvider(ArgusRecordSetProvider recordSetProvider)
    {
            ...
            List<ColumnHandle> columns)
    {
        ...
        if (isSystemSchema(handle.getSchemaTableName().getSchemaName())) {
            ...
            return ConnectorPageSourceProvider.super.createPageSource(transaction, session, split, table,
                    columns);
        }
    }
}
