        ...
        extends ArgusMetadata
{
    ...
    public ArgusColumnarMetadata(TypeManager typeManager, ArgusSystemTable mappedMetricsTable)
    {
        super(typeManager, ImmutableSet.of(mappedMetricsTable), mappedMetricsTable);
    }
